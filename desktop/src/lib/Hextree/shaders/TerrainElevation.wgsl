...
fn main(@builtin(global_invocation_id) id: vec3<u32>) {
    ...
    var noise = params.warpStrength * warp_fbm(offsetPos * params.scale, i32(params.octaves)) + 
                params.baseStrength * fbm(offsetPos * params.scale, i32(params.octaves), 2.0, params.persistence);
