...
#define IS_MESHPHYSICALMATERIAL;
#define IS_FRAGMENT
#define STANDARD
#ifdef PHYSICAL
  #define IOR
...
vec4 noaaRampColors[NOAA_RAMP_SIZE] = vec4[](
    ...
    vec4(0.878, 0.843, 0.816, 1.0), 
    vec4(0.804, 0.725, 0.612, 1.0), 
    vec4(0.729, 0.580, 0.408, 1.0), 
    vec4(0.608, 0.494, 0.263, 1.0), 
    vec4(0.459, 0.459, 0.176, 1.0), 
    vec4(0.271, 0.424, 0.094, 1.0), 
    vec4(0.090, 0.333, 0.082, 1.0), 
    vec4(0.000, 0.251, 0.137, 1.0), 
    vec4(0.878, 0.988, 0.894, 1.0), 
    vec4(0.671, 0.886, 0.843, 1.0), 
    vec4(0.475, 0.776, 0.804, 1.0), 
    vec4(0.361, 0.675, 0.792, 1.0), 
    vec4(0.247, 0.569, 0.780, 1.0), 
    vec4(0.176, 0.459, 0.690, 1.0), 
    vec4(0.133, 0.333, 0.502, 1.0), 
    vec4(0.114, 0.251, 0.322, 1.0), 
    vec4(0.102, 0.204, 0.204, 1.0)  
);
...
HexTileFloatData getHexTileFloatData(float tileIndex) {
    ...
    result.annualPrecipitation = data.g * 5000.0; 
    result.annualTemperature = data.b * 100.0 - 50.0; 
...
IncidentLight directLight;
  ...
  SpotLightShadow spotLightShadow;
    ...
    #define SPOT_LIGHT_MAP_INDEX 0
    #else
    #define SPOT_LIGHT_MAP_INDEX ( 0 - 0 + 0 )
    #endif
